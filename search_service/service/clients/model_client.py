...
DEFAULT_EMPTY_COMMENTS = "отсутствуют"
...
def build_prompt(problem: str, comments: str = DEFAULT_EMPTY_COMMENTS) -> str:
...
class ModelServiceClient:
    ...
    async def _summarize_chunks(
        ...
        available_tokens = MAX_CONTEXT_TOKENS - self._estimate_tokens(problem)
    ...
    async def _reduce_summaries(self, summaries: List[str]) -> str:
        ...
        return await self._generate_json(
            ...
            comments=DEFAULT_EMPTY_COMMENTS
        )
